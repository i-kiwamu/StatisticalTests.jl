@testset "One sample t-test" begin
    ...
    test_show(res_ttest)
    @test res_ttest.statistic ≈ 9.73641835357921
    @test res_ttest.dof == 9
    @test res_ttest.pval ≈ 4.46718590474277e-06
end
...
@testset "Paired t-test" begin
    ...
    @test res_ttest.statistic ≈ 3.52842907954346
    @test res_ttest.dof == 11
    @test res_ttest.pval ≈ 0.0047278741207561
end
...
@testset "Simple two sample t-test" begin
    ...
    @test res_ttest.statistic ≈ 2.22997773895153
    @test res_ttest.dof == 7
    @test res_ttest.pval ≈ 0.0609728704866215
end
...
@testset "Welch two sample t-test" begin
    ...
    test_show(res_ttest)
    @test res_ttest.statistic ≈ -1.86081346748685
    @test res_ttest.dof ≈ 17.7764735161785
    @test res_ttest.pval ≈ 0.0793941401873582
end
